import { parallelMergeSort } from './parallel-merge-sort';
...
describe('parallelMergeSort - test data', () => {
  ...
  Object.entries(data).forEach(([key, value]) => {
    ...
    it(`should sort an array for ${key}`, () => {
      ...
      const sortedArray = parallelMergeSort(unsortedArray);
...
describe('parallelMergeSort - test complexity', () => {
